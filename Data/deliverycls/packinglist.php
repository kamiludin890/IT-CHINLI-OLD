...
if (ambil_database(size1,sales_po,"id='$id_sales_po'")!='') {
  ...
  echo "<td rowspan='3'></td>";}else{$pengganti1=1;}
if (ambil_database(size2,sales_po,"id='$id_sales_po'")!='') {
  ...
  echo "<td rowspan='3'></td>";}else{$pengganti2=1;}
if (ambil_database(size3,sales_po,"id='$id_sales_po'")!='') {
  ...
  echo "<td rowspan='3'></td>";}else{$pengganti3=1;}
//SALES PO END
...
echo "<td colspan='$grand_total_pengganti_bagi' rowspan='2'>$total_pengganti1</td>";
}
