...
//PECAH
$column_items='no,po_nomor,line_batch,departement,kode_barang,material_description_po,cauge_width,satuan,qty_purchasing,harga,total_harga,etd,remark,pcx_no,season,shoe_model,supplier_alocation,foto';
...
$objDrawing->setCoordinates("R$start_kolom");
//setOffsetX works properly
...
$objPHPExcel->getActiveSheet()->getStyle("A11:R$jumlah_data")->applyFromArray($styleArray);
unset($styleArray);
//PERINTAH BORDER END
...
//PERINTAH BOLD
$objPHPExcel->getActiveSheet()->getStyle("A11:S11")->getFont()->setBold( true );
$objPHPExcel->getActiveSheet()->getStyle("A$jumlah_data:S$jumlah_data")->getFont()->setBold( true );
//PERINTAH BOLD END


$objPHPExcel->setActiveSheetIndex(0);
header('Content-Type: application/vnd.ms-excel');
header("Content-Disposition: attachment;filename=poclaim_purchasing_$nomor_po.xls");
