...
$column_items='kode_barang,material_description_po,cauge_width,satuan,qty_purchasing,harga,total_harga,etd,remark,pcx_no,season,shoe_model,supplier_alocation';
...
echo "<td><center><img src='../../gambar/$logo_lengkap' width='80%' height='70%'/><center></td>";
...
// $sql03="SELECT * FROM admin_purchasing_dokumen_masuk WHERE induk='$id'";
...
if ($grand_qty_spk==$total_masuk) {
	$color_n='white';//#00FFFF
}else {
	$color_n='white';//#FF6347
}

//GRAND TOTAL
echo "<tr>";
echo "<td colspan='5' style='font-size:10px;'><strong>".ambil_database($bahasa,pusat_bahasa,"kode='total'")."</strong></td>";
echo "<td style='font-size:10px; background-color:$color_n;'><strong>$grand_qty_spk</strong></td>";
...
if (ambil_database(jenis_mata_uang,$nama_database_items,"induk='$id'")=='RP') {
	echo "<td style='font-size:10px;'><strong>".rupiah($grand_amount_rp)."</strong></td>";
}elseif (ambil_database(jenis_mata_uang,$nama_database_items,"induk='$id'")=='USD') {
	echo "<td style='font-size:10px;'><strong>".dollar($grand_amount_usd)."</strong></td>";
}elseif (ambil_database(jenis_mata_uang,$nama_database_items,"induk='$id'")=='NT') {
	echo "<td style='font-size:10px;'><strong>".dollar_nt($grand_amount_nt)."</strong></td>";
}
...
echo "<tr>";
echo "<td colspan='5' style='font-size:10px;'><strong>".ambil_database($bahasa,pusat_bahasa,"kode='discount'")."</strong></td>";
echo "<td style='font-size:10px;'><strong>".$jmlh_diskon."%</strong></td>";
echo "<td style='font-size:12px;'><strong></strong></td>";//".dollar($grand_price_usd)."

if (ambil_database(jenis_mata_uang,$nama_database_items,"induk='$id'")=='RP') {
	echo "<td style='font-size:10px;'><strong>".rupiah($grand_amount_rp_diskon)."</strong></td>";
}elseif (ambil_database(jenis_mata_uang,$nama_database_items,"induk='$id'")=='USD') {
	echo "<td style='font-size:10px;'><strong>".dollar($grand_amount_usd_diskon)."</strong></td>";
}elseif (ambil_database(jenis_mata_uang,$nama_database_items,"induk='$id'")=='NT') {
	echo "<td style='font-size:10px;'><strong>".dollar_nt($grand_amount_nt_diskon)."</strong></td>";
}
...
if (ambil_database(jenis_mata_uang,$nama_database_items,"induk='$id'")=='RP') {
	echo "<td style='font-size:10px; white-space:nowrap;'><strong>".rupiah($grand_amount_rp-$grand_amount_rp_diskon)."</strong></td>";
}elseif (ambil_database(jenis_mata_uang,$nama_database_items,"induk='$id'")=='USD') {
	echo "<td style='font-size:10px; white-space:nowrap;'><strong>".dollar($grand_amount_usd-$grand_amount_usd_diskon)."</strong></td>";
}elseif (ambil_database(jenis_mata_uang,$nama_database_items,"induk='$id'")=='NT') {
	echo "<td style='font-size:10px; white-space:nowrap;'><strong>".dollar_nt($grand_amount_nt-$grand_amount_nt_diskon)."</strong></td>";
}
