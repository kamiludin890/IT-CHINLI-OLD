...
echo "<option value='OTH'>OTH</option>";
echo "</select></td>";
}
//TAMPILAN SEBENARNYA
else{
...
echo "<table><tr>";
	echo "<td>";
  echo "<a href='$address&id=".base64_encrypt($rows1[id],"XblImpl1!A@")."&opsi=".base64_encrypt("tambah","XblImpl1!A@")."&halaman=$nomor_halaman&pilihan_tahun=$pilihan_tahun&pilihan_bulan=$pilihan_bulan&pilihan_pencarian=$pilihan_pencarian&pencarian=$pencarian'><img src='modules/gambar/tambah.png' width='25px'/></a>";

if ($address=='?mod=admincls/purchasing') {
	echo "</td><td>
	      <form method ='POST' action='modules/admincls/cetak/print_excel_purchasing_all.php' target='_blank'>
