...
if ($jenis_import=='PURCHASING') {
				...
				for ($i=2; $i<=$jumlah_baris; $i++){
					...
					if ($nilai!='' AND ambil_database(nomor_aju,akuntansiv3_jurnal,"nomor_aju='$nomor_aju' AND jenis_input='PURCHASING'")=='') {
					...
					//RP END
						...
						if ($nilai_usd!='' AND ambil_database(nomor_aju,akuntansiv3_jurnal_usd,"nomor_aju='$nomor_aju' AND jenis_input='PURCHASING'")=='') {
