...
if ($hapus) {
	if($halaman==''){
		$delete="DELETE FROM akuntansiv3_akun WHERE induk='$hapus'";
	}else{
		$delete="DELETE FROM akuntansiv3_akun WHERE id='$hapus'";
	}
...
$insert="INSERT INTO akuntansiv3_akun	SET induk='$induk',kelompok='$kelompok',nomor='$nomor',nama='$nama',kolom='$kolom',pembeda_laba_rugi='$pembeda_laba_rugi',tampil='$tampil'";
...
$sql9="SELECT * FROM akuntansiv3_akun	WHERE nomor='$induk'";
...
if($halaman=='rincian') {
	...
	//TABEL AWAL START
		...
		$sql1="SELECT * FROM akuntansiv3_akun WHERE induk='$induk' AND tampil='yes' $tambahan_pencarian_rincian ORDER BY nomor";
...
//TABEL AWAL START
	...
	$sql1="SELECT * FROM akuntansiv3_akun WHERE tampil='' $tambahan_pencarian ORDER BY nomor";
	$result1=mysql_query($sql1);
	$no=1;
	while($rows1=mysql_fetch_array($result1)){
		$warnaGenap="#FFFFF";	$warnaGanjil="#CEF6F5";
