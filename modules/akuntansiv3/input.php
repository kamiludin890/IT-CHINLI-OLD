...
//IMPORT END
	...
	echo "<table>";
		...
		//PENJUALAN SALES
		echo "<tr>";
		echo "<td><form method ='POST' action='modules/akuntansiv3/cetak/penjualan_sales.php' target='_blank'>";
		...
		echo "<tr>";
		echo "<td><form method ='POST' action='modules/akuntansiv3/cetak/penjualan_receive_sales.php' target='_blank'>";
		...
		echo "<tr>";
		echo "<td><form method ='POST' action='modules/akuntansiv3/cetak/penjualan_discount_sales.php' target='_blank'>";
		//<input type='image' src='modules/gambar/save_excel.png' width='25' height'25' name='print' value='print'>
