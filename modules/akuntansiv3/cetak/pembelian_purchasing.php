...
$query=mysql_query("SELECT * FROM akuntansiv3_faktur_masukkan WHERE tanggal BETWEEN '$periode1' AND '$periode2'");
$no =2;
while ($rows1=mysql_fetch_array($query)){
	...
	$objPHPExcel->getActiveSheet()->setCellValue("L$no", "$rows1[keterangan]");
