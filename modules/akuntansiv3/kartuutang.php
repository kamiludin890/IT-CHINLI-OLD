	...
	$address='?menu=home&mod=akuntansiv3/kartuutang';
	...
	// $list_akun=
	//SALDO AWAL
	$saldo_awal=ambil_database("SUM(debit)",akuntansiv3_jurnal,"tanggal BETWEEN '$awal_periode1' AND '$awal_periode2' AND nomor LIKE '610.4%'");
	echo "<tr>";
	echo "<td>1</td>";
	...
	$sql=mysql_query("SELECT * FROM akuntansiv3_jurnal WHERE nomor LIKE '610.4%' AND tanggal BETWEEN '$akhir_periode1' AND '$akhir_periode2' ORDER BY tanggal,id");
	$no=2;
