...
function home(){extract($GLOBALS);
	...
	$rows1=mysql_fetch_array($result1);
		...
		echo "<form action='?menu=home&mod=akuntansiv3/jurnal' method='POST'>
					<label>Tanggal</label>
...
$_SESSION['sbsources']= array( 'mod' => $d['mod'], 'id' => $id );
	...
	<form name=myform action='?mod=$d[mod]&menu=aksi' method='post' id='contactform'>
		...
		$sql1="SELECT * FROM akuntansiv3_akun ORDER BY nomor";
		$result1= mysql_query($sql1);
		echo "
		<tr>
		<td>Nomor</td>
		...
		$sql2="SELECT * FROM akuntansiv3_akun ORDER BY nomor";
		...
		$sql3="SELECT * FROM akuntansiv3_akun ORDER BY nomor";
