...
$nama_database='akuntansiv2_posting_master';
$nama_database_items='akuntansiv2_posting';

$address='?menu=home&mod=akuntansiv2/posting';
...
if ($_GET['fnh']) {
	...
	$nama=ambil_database(keterangan,akuntansiv2_persamaan,"id='".ambil_database(persamaan,akuntansiv2_posting_master,"id='$id'")."'");

	//Hapus Dulu
	mysql_query("DELETE FROM akuntansiv2_jurnal WHERE induk_master='$id'");
...
//DEBIT
$keterangan_debit=ambil_database(nama,akuntansiv2_akun,"nomor='$rows[debit]'");
$pembeda_saldo_awal_debit=ambil_database(pembeda_neraca,akuntansiv2_akun,"nomor='$rows[debit]'");
$pembeda_laba_rugi_debit=ambil_database(pembeda_laba_rugi,akuntansiv2_akun,"nomor='$rows[debit]'");
		mysql_query("INSERT INTO akuntansiv2_jurnal SET
			induk='$rows[id]',
			induk_master='$id',
			ref='$rows[ref]',
			tanggal='$tanggal',
...
//KREDIT
$keterangan_kredit=ambil_database(nama,akuntansiv2_akun,"nomor='$rows[kredit]'");
$pembeda_saldo_awal_kredit=ambil_database(pembeda_neraca,akuntansiv2_akun,"nomor='$rows[kredit]'");
$pembeda_laba_rugi_kredit=ambil_database(pembeda_laba_rugi,akuntansiv2_akun,"nomor='$rows[kredit]'");
		mysql_query("INSERT INTO akuntansiv2_jurnal SET
			induk='$rows[id]',
			induk_master='$id',
			ref='$rows[ref]',
	...
	//KREDIT KEDUA
	$keterangan_kredit_kedua=ambil_database(nama,akuntansiv2_akun,"nomor='$rows[kredit_kedua]'");
	$pembeda_saldo_awal_kredit_kedua=ambil_database(pembeda_neraca,akuntansiv2_akun,"nomor='$rows[kredit_kedua]'");
	$pembeda_laba_rugi_kredit_kedua=ambil_database(pembeda_laba_rugi,akuntansiv2_akun,"nomor='$rows[kredit_kedua]'");
			mysql_query("INSERT INTO akuntansiv2_jurnal SET
				induk='$rows[id]',
				induk_master='$id',
				ref='$rows[ref]',
...
//HEADER
	echo "<table style='font-size:22px;'>";
		...
		echo "<tr>";
			echo "<td>Tanggal</td>";
			echo "<td>:</td>";
			echo "<td>".ambil_database(tanggal,akuntansiv2_posting_master,"id='$id'")."</td>";
		echo "</tr>";

		echo "<tr>";
			echo "<td>Kode</td>";
			echo "<td>:</td>";
			echo "<td>".ambil_database(kode,akuntansiv2_posting_master,"id='$id'")."</td>";
		echo "</tr>";

		// echo "<tr>";
		// 	echo "<td>Jenis Kas</td>";
		// 	echo "<td>:</td>";
		// 	echo "<td>".ambil_database(jenis_kas,akuntansiv2_posting_master,"id='$id'")."</td>";
		// echo "</tr>";

		echo "<tr>";
			echo "<td>Keterangan</td>";
			echo "<td>:</td>";
			echo "<td>".ambil_database(keterangan,akuntansiv2_posting_master,"id='$id'")."</td>";
		echo "</tr>";

		$kelompok=ambil_database(kelompok,akuntansiv2_persamaan,"id='".ambil_database(persamaan,akuntansiv2_posting_master,"id='$id'")."'");
		$keterangan=ambil_database(keterangan,akuntansiv2_persamaan,"id='".ambil_database(persamaan,akuntansiv2_posting_master,"id='$id'")."'");
		echo "<tr>";
		...
		$nama_debit=ambil_database(nama,akuntansiv2_akun,"nomor='$debit'");
		echo "<tr>";
			echo "<td>Debit</td>";
			echo "<td>:</td>";
		...
		$nama_kredit=ambil_database(nama,akuntansiv2_akun,"nomor='$kredit'");
		echo "<tr>";
			echo "<td>Kredit</td>";
			echo "<td>:</td>";
		...
		$nama_kredit_kedua=ambil_database(nama,akuntansiv2_akun,"nomor='$kredit_kedua'");
		// echo "<tr>";
...
if (ambil_database(status,akuntansiv2_posting_master,"id='$id'")!="Selesai"){
	echo "<table style='margin-top:20px;'>";
		echo "<tr>";

			echo "<td>";
				echo '<a href="#" style="" onClick="window.open(\''."modules/akuntansiv2/posting_tambah.php?id=".base64_encrypt($id,'XblImpl1!A@')."".'\', \''.'mywindow'.'\', \''.'directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=1500,height=550'.'\')">'."Tambah".'</a>';//<img src='modules/gambar/tambah.png' width='30px' height='30px'/>
			echo "</td>";
				echo "<td> | </td>";
			echo "<td>";
				echo '<a href="#" style="" onClick="window.open(\''."modules/akuntansiv2/posting_inputbc.php?id=".base64_encrypt($id,'XblImpl1!A@')."".'\', \''.'mywindow'.'\', \''.'directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=1500,height=550'.'\')">'."Dokumen BC".'</a>';//<img src='modules/gambar/tambah.png' width='30px' height='30px'/>
			echo "</td>";
				echo "<td> | </td>";
			echo "<td>";
				echo '<a href="#" style="" onClick="window.open(\''."modules/akuntansiv2/posting_inputinternal.php?id=".base64_encrypt($id,'XblImpl1!A@')."".'\', \''.'mywindow'.'\', \''.'directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=1500,height=550'.'\')">'."Dokumen Internal".'</a>';//<img src='modules/gambar/tambah.png' width='30px' height='30px'/>
			echo "</td>";
				echo "<td> | </td>";
			echo "<td>";
				echo '<a href="#" style="" onClick="window.open(\''."modules/akuntansiv2/posting_edit.php?id=".base64_encrypt($id,'XblImpl1!A@')."".'\', \''.'mywindow'.'\', \''.'directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=1000,height=350'.'\')">'."Edit".'</a>';//<img src='modules/gambar/edit.png' width='30px' height='30px'/>
			echo "</td>";
				echo "<td> | </td>";
			echo "<td>";
