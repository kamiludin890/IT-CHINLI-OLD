...
// 	echo "</br>
// 	<form method ='post' action='?menu=home&mod=akuntansiv2/posting2'>
...
// 	</br>";
	...
	echo "
	<form action='?menu=home&mod=akuntansiv2/posting2' method='POST'>
	<label>Cari :</label>
	</br>
									...
									while ($rows1=mysql_fetch_array($query)){
										...
										// }else {$surat_jalan='';}
																		...
																		echo "<tr>
																						...
																						$catatan_selesai=ambil_database(catatan,akuntansiv2_posting," nomor_aju='$rows1[nomor_aju]' AND status='Selesai'");
																					if(ambil_database(status,akuntansiv2_posting," nomor_aju='$rows1[nomor_aju]' AND status='Selesai'")=='Selesai'){
																						echo "<td>Selesai</td>
...
if ($_POST['nomor_faktur']) {
  ...
  $nominal_kredit1=$_POST['nominal_kredit'];
    ...
    $id_ke_jurnal = preg_replace('/\D/', '', $tgl_id);
		...
		if (ambil_database(ref,akuntansiv2_posting,"ref='$id_ke_jurnal'")=='' AND ambil_database(ref,akuntansiv2_jurnal,"ref='$id_ke_jurnal'")=='') {
