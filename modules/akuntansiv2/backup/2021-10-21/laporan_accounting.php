...
function editmenu(){extract($GLOBALS);
	...
	$rows1=mysql_fetch_array($result1);
		...
		echo "<form action='?menu=home&mod=akuntansiv2/laporan' method='POST'>
					<label>Tanggal</label>
...
function laba_rugi(){extract($GLOBALS); 	global $tl;
	$rest=" WHERE tanggal BETWEEN '$p[0];' AND '$p[1];' ";
 	$rest .=" AND akuntansiv2_akun.nomor=akuntansiv2_jurnal.nomor ";
 	$rest .=" AND akuntansiv2_akun.kelompok='pendapatan' ";
 	$rest .=" GROUP BY akuntansiv2_akun.nomor ORDER BY akuntansiv2_akun.nomor ASC";
	dropmenu2();
 	$query = "SELECT * ,sum(akuntansiv2_jurnal.debit) AS debit, sum(akuntansiv2_jurnal.kredit) as kredit FROM akuntansiv2_jurnal,akuntansiv2_akun $rest ";
...
//	echo l('periode'). $p[0] . " s/d ". $p[1];
	...
	$query2 = "SELECT * ,sum(akuntansiv2_jurnal.debit) AS debit, sum(akuntansiv2_jurnal.kredit) as kredit FROM akuntansiv2_jurnal,akuntansiv2_akun
	WHERE tanggal BETWEEN '$p[0];' AND '$p[1];' and akuntansiv2_akun.nomor=akuntansiv2_jurnal.nomor AND akuntansiv2_akun.kelompok='beban' GROUP BY akuntansiv2_akun.nomor ORDER BY akuntansiv2_akun.nomor ASC";
...
function ekuitas(){extract($GLOBALS); global $modal;
 	dropmenu2();
	$query = "SELECT * ,sum(akuntansiv2_jurnal.debit) AS debit, sum(akuntansiv2_jurnal.kredit) as kredit FROM akuntansiv2_jurnal,akuntansiv2_akun
	WHERE tanggal BETWEEN '$p[0];' AND '$p[1];' and akuntansiv2_akun.nomor=akuntansiv2_jurnal.nomor AND akuntansiv2_akun.kelompok='ekuitas' GROUP BY akuntansiv2_akun.nomor ORDER BY akuntansiv2_akun.nomor ASC";
	$_SESSION['myquery']=$query;
	$result = mysql_query($query) or die('Error');
...
function neraca(){extract($GLOBALS); 	global $tl;
	...
	$query = "SELECT * ,sum(akuntansiv2_jurnal.debit) AS debit, sum(akuntansiv2_jurnal.kredit) as kredit FROM akuntansiv2_jurnal,akuntansiv2_akun
	WHERE tanggal BETWEEN '$p[0];' AND '$p[1];' and akuntansiv2_akun.nomor=akuntansiv2_jurnal.nomor AND akuntansiv2_akun.kelompok='aktiva' GROUP BY akuntansiv2_akun.nomor ORDER BY akuntansiv2_akun.nomor ASC";
	$_SESSION['myquery']=$query;
...
//	echo l('periode'). $p[0] . " s/d ". $p[1];
	...
	$query2 = "SELECT * ,sum(akuntansiv2_jurnal.debit) AS debit, sum(akuntansiv2_jurnal.kredit) as kredit FROM akuntansiv2_jurnal,akuntansiv2_akun
	WHERE tanggal BETWEEN '$p[0];' AND '$p[1];' and akuntansiv2_akun.nomor=akuntansiv2_jurnal.nomor AND akuntansiv2_akun.kelompok='passiva' GROUP BY akuntansiv2_akun.nomor ORDER BY akuntansiv2_akun.nomor ASC";
	$result2 = mysql_query($query2) or die('Error');
