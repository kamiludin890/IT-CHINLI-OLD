...
$column_header='tanggal,keterangan,debit,kredit,status';//kredit_kedua,
$column='tanggal,keterangan,debit,kredit,status,pembuat,tgl_dibuat';//kredit_kedua,
...
$nama_database='akuntansiv2_persamaan';
//$nama_database_items='admin_purchasing_items';

$address='?menu=home&mod=akuntansiv2/persamaan';
