							...
							<table align='center' width='100%' border='2' cellpadding='3' cellspacing='1' bgcolor='#CCCCCC'>
								<tr>
									...
									<td style='padding: 5px; color:black; background-color: #E0FFFF;' align='center' width='40px' bgcolor='#FFFFFF'><strong></strong></td>
										...
										$sql3="SELECT * FROM akuntansiv2_akun WHERE tampil='yes' AND nomor LIKE '%$rows2[nomor].%'";
...
if ($idhal==230) {
	...
	$nomor=$_POST['nomor'];
	$nama=$_POST['nama'];
	$upload = "INSERT IGNORE INTO akuntansiv2_akun (kelompok,nomor,nama,induk) VALUES('$kelompok','$nomor','$nama','$nomor')";
...
if ($idhal==210) {
	...
	$nomor=$_POST['nomor'];
	$nama=$_POST['nama'];
	$upload = "UPDATE akuntansiv2_akun SET kelompok='$kelompok',nomor='$nomor',nama='$nama' WHERE id='$iddeletehome' ";
	$hasil = mysql_query($upload);
	echo "
...
if ($idhal==130) {
	...
	$iddaftarproduk=$_POST['iddaftarproduk'];
	$upload = "INSERT IGNORE INTO akuntansiv2_akun (kelompok,nomor,nama,tampil,induk) VALUES('$kelompok','$nomor','$nama','$tampil','$nomorinduk')";
	$hasil = mysql_query($upload);
	echo "
		<h2>Data Telah Disimpan</h2>
	  <form action='?menu=home&mod=akuntansiv2/akun' method='POST'>
