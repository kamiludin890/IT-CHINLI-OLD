...
//IMPORT END
	...
	echo "<table>";
		...
		//HEADER PENJUALAN
		echo "<tr><td style='font-weight:bold;' colspan='3'>PENJUALAN :</td></tr>";


		//PENJUALAN SALES
		echo "<tr>";
		echo "<td><form method ='POST' action='modules/akuntansiv2/cetak/penjualan_sales.php' target='_blank'>";
		echo "<input type='submit' style='width:100%;' name='submit' value='Sales'
		...
		echo "<td>";
			...
			echo "<input type='submit' name='Import' value='Import'>
						<input type='hidden' name='import_excel_form' value='SALES'>
						<input type='hidden' name='periode1' value='$periode1'>
		...
		//PENJUALAN RECEIVE SALES
		echo "<tr>";
		echo "<td><form method ='POST' action='modules/akuntansiv2/cetak/penjualan_receive_sales.php' target='_blank'>";
		//<input type='image' src='modules/gambar/save_excel.png' width='25' height'25' name='print' value='print'>
		echo "<input type='submit' style='width:100%;' name='submit' value='Receive Sales'
					<input type='hidden' name='nama_database1' value='$nama_database'>
					<input type='hidden' name='periode1' value='$periode1'>
					<input type='hidden' name='periode2' value='$periode2'>
					</form></td>";
		echo "<td>";
			echo "<form method ='post' action=''>";
			echo "<input type='submit' name='Import' value='Import'>
						<input type='hidden' name='import_excel_form' value='RECEIVE SALES'>
						<input type='hidden' name='periode1' value='$periode1'>
						<input type='hidden' name='periode2' value='$periode2'></form>";
		echo "</td>";
		echo "</tr>";
		//PENJUALAN RECEIVE SALES END


		//PENJUALAN Discount SALES
		echo "<tr>";
		echo "<td><form method ='POST' action='modules/akuntansiv2/cetak/penjualan_discount_sales.php' target='_blank'>";
		//<input type='image' src='modules/gambar/save_excel.png' width='25' height'25' name='print' value='print'>
		echo "<input type='submit' style='width:100%;' name='submit' value='Discount Sales'
					<input type='hidden' name='nama_database1' value='$nama_database'>
					<input type='hidden' name='periode1' value='$periode1'>
					<input type='hidden' name='periode2' value='$periode2'>
					</form></td>";
		echo "<td>";
			echo "<form method ='post' action=''>";
			echo "<input type='submit' name='Import' value='Import'>
						<input type='hidden' name='import_excel_form' value='DISCOUNT SALES'>
						<input type='hidden' name='periode1' value='$periode1'>
						<input type='hidden' name='periode2' value='$periode2'></form>";
		echo "</td>";
		echo "</tr>";
	...
	// 		echo "<td><form method ='POST' action='modules/akuntansiv2/cetak/penjualan_receive_sales.php' target='_blank'>";
	// 		//<input type='image' src='modules/gambar/save_excel.png' width='25' height'25' name='print' value='print'>
	// 		echo "<input type='submit' name='submit' value='Payment'
	// 					<input type='hidden' name='nama_database1' value='$nama_database'>
	// 					<input type='hidden' name='periode1' value='$periode1'>
	// 					<input type='hidden' name='periode2' value='$periode2'>
	// 					</form></td>";
	...
	// 		echo "<td><form method ='POST' action='modules/akuntansiv2/cetak/penjualan_discount_sales.php' target='_blank'>";
	// 		//<input type='image' src='modules/gambar/save_excel.png' width='25' height'25' name='print' value='print'>
	// 		echo "<input type='submit' name='submit' value='Discount Purchase'
	// 					<input type='hidden' name='nama_database1' value='$nama_database'>
	// 					<input type='hidden' name='periode1' value='$periode1'>
	// 					<input type='hidden' name='periode2' value='$periode2'>
	// 					</form></td>";
