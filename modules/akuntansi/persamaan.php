...
$column_header='tanggal,kelompok,keterangan,debit,kredit,kredit_kedua,status';
$column='tanggal,kelompok,keterangan,debit,kredit,kredit_kedua,status,pembuat,tgl_dibuat';
...
$nama_database='akuntansi_persamaan';
//$nama_database_items='admin_purchasing_items';

$address='?menu=home&mod=akuntansi/persamaan';
