...
$column_header='tanggal,ref,tanggal_input,nomor,nama,keterangan,debit,kredit,kode_posting';
...
$nama_database='akuntansi_jurnal';
//$nama_database_items='admin_purchasing_items';

$address='?menu=home&mod=akuntansi/jurnal';
