<?php global $mod, $tbl, $fld,$cfield_name, $kolom, $title, $sekarang,$row ,$p, $periode, $akses, $tl;
	...
	$username10=$_SESSION['username'];
		...
		echo "
		<h2 style='text-align:center'>PT. CHINLI PLASTIC TECHNOLOGY INDONESIA</h2>
		";

$jenis_laporan=$_POST['jenis_laporan'];
echo "</br>
<form method ='post' action='?menu=home&mod=akuntansi/laporan'>
<tr>
 <td>LAPORAN</td>
 <td>:</td>
...
echo "<form method ='post' action='?menu=home&mod=akuntansi/laporan'>
<table>
<tr>
...
//$sql1="SELECT DISTINCT keterangan,nomor FROM akuntansi_jurnal WHERE tanggal BETWEEN '2019-08-01' AND '2019-08-31' AND nomor>'0' ORDER BY nomor";
$sql1="SELECT * FROM akuntansi_akun WHERE nomor>'0' AND kolom IN ('DEBIT','KREDIT') ORDER BY nomor";
...
echo "  <tr>
						...
						//Nilai Saldo Awal
						$query2="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor='$rows1[nomor]' AND tanggal BETWEEN '$rows2[saldo_awal1]' AND '$rows2[saldo_awal2]'";
...
echo "      <td $warna_master align='right'>$hasil_total_debit1</td>
						...
						//Nilai Mutasi
						$query3="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor='$rows1[nomor]' AND tanggal BETWEEN '$rows2[mutasi1]' AND '$rows2[mutasi2]'";
...
//PENJUALAN
	...
	$sql1="SELECT * FROM akuntansi_akun WHERE pembeda_laba_rugi='PENJUALAN' ORDER BY nomor";
  $result1=mysql_query($sql1);
	$n=1;
	while ($rows1=mysql_fetch_array($result1)){
	$query34="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor='$rows1[nomor]' AND tanggal LIKE '%$periode_laba_rugi%'";
	$result34=mysql_query($query34);
	$row34=mysql_fetch_array($result34);
	$nilai_penjualan_kredit=$row34['SUM(debit)'];
	...
	echo "<tr>
			...
			$sql1="SELECT * FROM akuntansi_akun WHERE pembeda_laba_rugi='RETUR/PPN PENJUALAN' ORDER BY nomor";
		  $result1=mysql_query($sql1);
			$n=1;
			while ($rows1=mysql_fetch_array($result1)){
			$query46="SELECT SUM(kredit) FROM akuntansi_jurnal WHERE nomor='$rows1[nomor]' AND tanggal LIKE '%$periode_laba_rugi%'";
...
//HARGA POKOK PENJUALAN
			...
			$sql1="SELECT * FROM akuntansi_akun WHERE pembeda_laba_rugi='HARGA POKOK PENJUALAN' ORDER BY nomor";
		  $result1=mysql_query($sql1);
			$n=1;
			while ($rows1=mysql_fetch_array($result1)){
			$query38="SELECT SUM(debit) FROM akuntansi_jurnal WHERE nomor='$rows1[nomor]' AND tanggal LIKE '%$periode_laba_rugi%'";
...
//HARGA PERSEDIAAN BARANG JADI
			...
			$sql1="SELECT * FROM akuntansi_akun WHERE pembeda_laba_rugi='PERSEDIAAN BARANG JADI' ORDER BY nomor";
		  $result1=mysql_query($sql1);
			$n=1;
			while ($rows1=mysql_fetch_array($result1)){
			$query42="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor='$rows1[nomor]' AND tanggal LIKE '%$periode_laba_rugi%'";
			...
			echo "<tr>
				  ...
				  $sql1="SELECT * FROM akuntansi_akun WHERE pembeda_laba_rugi='BIAYA PEMASARAN' ORDER BY nomor";
				  $result1=mysql_query($sql1);
					$n=1;
					while ($rows1=mysql_fetch_array($result1)){
				  $query38="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor='$rows1[nomor]' AND tanggal LIKE '%$periode_laba_rugi%'";
				  $result38=mysql_query($query38);
					$row38=mysql_fetch_array($result38);
...
//					$grand_total_biaya_pemasaran1=rupiah($grand_total_biaya_pemasaran);
					...
					$sqlbp="SELECT * FROM akuntansi_akun WHERE pembeda_laba_rugi='BIAYA POTONGAN' ORDER BY nomor";
					$resultbp=mysql_query($sqlbp);
					$n=1;
					while ($rowsbp=mysql_fetch_array($resultbp)){
					$querybp1="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor='$rowsbp[nomor]' AND tanggal LIKE '%$periode_laba_rugi%'";
	...
	$sql1="SELECT * FROM akuntansi_akun WHERE pembeda_laba_rugi='BIAYA ADMINISTRASI UMUM' ORDER BY nomor";
	$result1=mysql_query($sql1);
	$n=1;
	while ($rows1=mysql_fetch_array($result1)){
	$query38="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor='$rows1[nomor]' AND tanggal LIKE '%$periode_laba_rugi%'";
	...
	$sql1="SELECT * FROM akuntansi_akun WHERE pembeda_laba_rugi='PENDAPATAN LAIN LAIN' ORDER BY nomor";
	$result1=mysql_query($sql1);
	$n=1;
	while ($rows1=mysql_fetch_array($result1)){
	$query38="SELECT SUM(debit) FROM akuntansi_jurnal WHERE nomor='$rows1[nomor]' AND tanggal LIKE '%$periode_laba_rugi%'";
	...
	//BIAYA LABA BERSIH
	$query40="SELECT SUM(debit) FROM akuntansi_jurnal WHERE pembeda_laba_rugi='PAJAK PENGHASILAN' AND tanggal LIKE '%$periode_laba_rugi%'";
	$result40=mysql_query($query40);
	$row40=mysql_fetch_array($result40);
	$penjualan_bersih_debit=$row40['SUM(debit)'];
	$query41="SELECT SUM(kredit) FROM akuntansi_jurnal WHERE pembeda_laba_rugi='PAJAK PENGHASILAN' AND tanggal LIKE '%$periode_laba_rugi%'";
...
//PERSDIAAN AWAL
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor='120.500' AND tanggal BETWEEN '$saldo_awal1' AND '$saldo_awal2'";
...
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor IN ('120.500','120.100') AND tanggal BETWEEN '$mutasi1' AND '$mutasi2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
...
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor IN ('120.300','120.200') AND tanggal BETWEEN '$mutasi1' AND '$mutasi2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
...
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor IN ('120.400') AND tanggal BETWEEN '$mutasi1' AND '$mutasi2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
...
//POTONGAN PEMBELIAN
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor IN ('407.100') AND tanggal BETWEEN '$mutasi1' AND '$mutasi2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
...
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor='120' AND tanggal BETWEEN '$mutasi1' AND '$mutasi2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
...
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor IN ('120.100') AND tanggal BETWEEN '$mutasi1' AND '$mutasi2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
...
echo "
<tr>
  <th style='background-color:; text-align:center;' colspan='2'>120.100</th>
...
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor IN ('122.100','122.500','122.501') AND tanggal BETWEEN '$saldo_awal1' AND '$saldo_awal2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
...
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor IN ('122.100','122.500','122.501') AND tanggal BETWEEN '$mutasi1' AND '$mutasi2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
...
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor IN ('466.100','466.200','466.500','466.800') AND tanggal BETWEEN '$mutasi1' AND '$mutasi2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
...
//BIAYA MOLD
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor IN ('602') AND tanggal BETWEEN '$mutasi1' AND '$mutasi2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
...
//BIAYA OLI DAN SOLAR
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor IN ('802') AND tanggal BETWEEN '$mutasi1' AND '$mutasi2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
...
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor IN ('467.800','467.500','467.100') AND tanggal BETWEEN '$mutasi1' AND '$mutasi2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
...
//BIAYA ASURANSI
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor IN ('487') AND tanggal BETWEEN '$mutasi1' AND '$mutasi2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
...
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor IN ('485') AND tanggal BETWEEN '$mutasi1' AND '$mutasi2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
...
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor IN ('154') AND tanggal BETWEEN '$mutasi1' AND '$mutasi2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
...
//BIAYA KALIBRASI
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor IN ('813') AND tanggal BETWEEN '$mutasi1' AND '$mutasi2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
...
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor IN ('489') AND tanggal BETWEEN '$mutasi1' AND '$mutasi2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
...
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor IN ('513') AND tanggal BETWEEN '$mutasi1' AND '$mutasi2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
...
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor IN ('581') AND tanggal BETWEEN '$mutasi1' AND '$mutasi2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
...
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor IN ('588') AND tanggal BETWEEN '$mutasi1' AND '$mutasi2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
...
//BIAYA PRINTING
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor IN ('511') AND tanggal BETWEEN '$mutasi1' AND '$mutasi2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
...
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor IN ('808') AND tanggal BETWEEN '$mutasi1' AND '$mutasi2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
...
$cari_data="SELECT SUM(debit),SUM(kredit) FROM akuntansi_jurnal WHERE nomor IN ('816') AND tanggal BETWEEN '$mutasi1' AND '$mutasi2'";
$cari_data_result=mysql_query($cari_data);
$cari_data_rows=mysql_fetch_array($cari_data_result);
$persediaan_awal_debit=$cari_data_rows['SUM(debit)'];
$persediaan_awal_kredit=$cari_data_rows['SUM(kredit)'];
