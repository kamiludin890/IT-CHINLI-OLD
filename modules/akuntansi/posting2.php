<?php global  $title, $mod, $tbl, $fld ,$p, $akses;
	$mod='akuntansi/posting2';
	$tbl='akuntansi_posting';
...
// 	echo "</br>
// 	<form method ='post' action='?menu=home&mod=akuntansi/posting2'>
...
// 	</br>";
	...
	echo "
	<form action='?menu=home&mod=akuntansi/posting2' method='POST'>
	<label>Cari :</label>
	</br>
									...
									while ($rows1=mysql_fetch_array($query)){
										...
										// }else {$surat_jalan='';}
																		...
																		echo "<tr>
																						...
																						$catatan_selesai=ambil_database(catatan,akuntansi_posting," nomor_aju='$rows1[nomor_aju]' AND status='Selesai'");
																					if(ambil_database(status,akuntansi_posting," nomor_aju='$rows1[nomor_aju]' AND status='Selesai'")=='Selesai'){
																						echo "<td>Selesai</td>
...
if ($_POST['nomor_faktur']) {
  ...
  $nominal_kredit1=$_POST['nominal_kredit'];
	...
	$sql18="SELECT * FROM akuntansi_posting WHERE id='$id_posting'";
	...
	$sql6="SELECT * FROM akuntansi_persamaan WHERE id='$id_persamaan'";
	...
	$sql9="SELECT * FROM akuntansi_akun WHERE nomor='$debit'";
	...
	$sql10="SELECT * FROM akuntansi_akun WHERE nomor='$kredit'";
	...
	$sql15="SELECT * FROM akuntansi_akun WHERE nomor='$kredit_kedua'";
	...
	function editform($id,$btn){ extract($GLOBALS);
		...
		$sql5="SELECT * FROM akuntansi_posting WHERE id='$induk'";
		...
		echo "</br>
					...
					$sql1="SELECT * FROM akuntansi_persamaan ORDER BY id";
		...
		<link rel='stylesheet' href='select_picker/css/bootstrap-select.min.css' type='text/css'>
			...
			<table>
			 ...
			 $sql11="SELECT * FROM akuntansi_persamaan WHERE id='$rows5[id_persamaan]'";
...
function selesai(){extract($GLOBALS);
	...
	$akun=getrow("nomor, nama","akuntansi_akun"," where nomor='$_POST[5]'");
	$query="INSERT INTO akuntansi_jurnal SET
		ref='$_POST[1]'
		,tanggal='$_POST[2]'
		,nomor='$_POST[5]'
		,nama='$akun[nama]'
	...
	$akun=getrow("nomor, nama","akuntansi_akun"," where nomor='$_POST[6]'");
	$query="INSERT INTO akuntansi_jurnal SET
		ref='$_POST[1]'
		,tanggal='$_POST[2]'
		,nomor='$_POST[6]'
