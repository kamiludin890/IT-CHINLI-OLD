<?php global $mod;
	$mod='bookinginvoice/pesansuratjalan';
...
$column_header='tanggal,surat_jalan,dari,keterangan,pembuat,departement,tgl_dibuat,status';
$column='ket_revisi,tanggal,surat_jalan,departement,dari,keterangan,total_dokumen,pembuat,tgl_dibuat';
...
$nama_database='booking_surat_jalan';
//$nama_database_items='admin_purchasing_items';

$address='?menu=home&mod=bookinginvoice/pesansuratjalan';
