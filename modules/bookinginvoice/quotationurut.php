<?php global $mod;
	$mod='bookinginvoice/quotationurut';
...
$column_header='tanggal,nomor_quotationurut,dari,keterangan,pembuat,departement,tgl_dibuat,status';
$column='ket_revisi,tanggal,nomor_quotationurut,dari,keterangan,total_dokumen,pembuat,tgl_dibuat';
...
$nama_database='booking_quotationurut';
//$nama_database_items='admin_purchasing_items';

$address='?menu=home&mod=bookinginvoice/quotationurut';
