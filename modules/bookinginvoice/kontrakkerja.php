<?php global $mod;
	$mod='bookinginvoice/kontrakkerja';
...
$column_header='tanggal,nomor_kontrakkerja,dari,keterangan,pembuat,departement,tgl_dibuat,status';
$column='ket_revisi,tanggal,nomor_kontrakkerja,departement,dari,keterangan,total_dokumen,pembuat,tgl_dibuat';
...
$nama_database='booking_kontrakkerja';
//$nama_database_items='admin_purchasing_items';

$address='?menu=home&mod=bookinginvoice/kontrakkerja';
