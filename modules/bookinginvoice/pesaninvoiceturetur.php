<?php global $mod;
	$mod='bookinginvoice/pesaninvoiceturetur';
...
function home(){extract($GLOBALS);
	// echo"<h1>Jikan mendapatkan invoice CPTI-2024-00473TU/PR/R harap untuk tidak digunakan dan booking ulang lagi 1 invoice</h1>";
include ('function.php');
$column_header='tanggal,no_invoice,dari,keterangan,pembuat,departement,tgl_dibuat,status';
$column='ket_revisi,tanggal,no_invoice,departement,jenis_invoice,dari,keterangan,total_dokumen,pembuat,tgl_dibuat';
...
$nama_database='booking_invoice_turetur';
//$nama_database_items='admin_purchasing_items';

$address='?menu=home&mod=bookinginvoice/pesaninvoiceturetur';
