<?php global $mod;
	$mod='bookinginvoice/kontrakjualbeli';
...
$column_header='tanggal,nomor_kontrakjualbeli,dari,keterangan,pembuat,departement,tgl_dibuat,status';
$column='ket_revisi,tanggal,nomor_kontrakjualbeli,departement,dari,keterangan,total_dokumen,pembuat,tgl_dibuat';
...
$nama_database='booking_kontrakjualbeli';
//$nama_database_items='admin_purchasing_items';

$address='?menu=home&mod=bookinginvoice/kontrakjualbeli';
