<?php global $mod;
	$mod='bookinginvoice/pesaninvoice';
...
$column='ket_revisi,tanggal,no_invoice,departement,dari,keterangan,total_dokumen,tipe_transaksi,pembuat,tgl_dibuat';
...
$nama_database='booking_invoice';
//$nama_database_items='admin_purchasing_items';

$address='?menu=home&mod=bookinginvoice/pesaninvoice';
