...
$column_header='tanggal,nomor_notaretur,dari,keterangan,pembuat,departement,tgl_dibuat,status';
$column='ket_revisi,tanggal,nomor_notaretur,departement,dari,keterangan,total_dokumen,pembuat,tgl_dibuat';
...
$nama_database='booking_notaretur';
//$nama_database_items='admin_purchasing_items';

$address='?menu=home&mod=bookinginvoice/notaretur';
