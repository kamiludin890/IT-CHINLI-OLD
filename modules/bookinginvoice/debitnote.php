...
$column_header='tanggal,nomor_debitnote,dari,keterangan,pembuat,departement,tgl_dibuat,status';
$column='ket_revisi,tanggal,nomor_debitnote,departement,dari,keterangan,total_dokumen,pembuat,tgl_dibuat';
...
$nama_database='booking_debitnote';
//$nama_database_items='admin_purchasing_items';

$address='?menu=home&mod=bookinginvoice/debitnote';
