<?php global $mod;
	$mod='hrddata/rekapfotobukukontrak';
...
$address='?mod=hrddata/rekapfotobukukontrak';
...
echo '<script type="text/javascript">window.open(\''."modules/hrddata/cetak/cetak_rekapfotobukukontrak.php?id_download=$kunci_list_pilihan".'\', \''.'mywindow'.'\', \''.'status=1,toolbar=1,width=600'.'\')</script>';
