...
$column_header='tanggal,nik,nama,bagian,jenis_pelanggaran,tanggal_pelanggaran,sp,tanggal_berlaku_sp,tanggal_berakhir_sp';
$column='ket_revisi,tanggal,id_pegawai,jenis_pelanggaran,tanggal_pelanggaran,sp,tanggal_berlaku_sp,pembuat,tgl_dibuat';

$nama_database='hrd_data_sp';
//$nama_database_items='admin_purchasing_items';

$address='?mod=hrddata/sp';
