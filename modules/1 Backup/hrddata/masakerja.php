...
$column_header='tanggal,id_pegawai,nik,nama,bagian,kontrak_ke,urutan,tambah_kontrak,status_pkwtt,tanggal_pkwtt';
$column='ket_revisi,tanggal,id_pegawai,kontrak_ke,tambah_kontrak,status_pkwtt,tanggal_pkwtt,pembuat,tgl_dibuat';//kontrak_awal1,kontrak_awal2,kontrak_akhir1,kontrak_akhir2,

$nama_database='hrd_data_masakerja';
//$nama_database_items='admin_purchasing_items';

$address='?mod=hrddata/masakerja';
