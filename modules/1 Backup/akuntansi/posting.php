...
elseif($jenis_kas_penentu=='') {
	...
	echo "</br>
	<form method ='post' action='?menu=home&mod=akuntansi/posting'>
	...
	echo "
	<form action='?menu=home&mod=akuntansi/posting' method='POST'>
	<label>Cari :</label>
	</br>
            ...
            <thead>
              ...
              <th>Catatan</th>
						...
						$rows22=mysql_fetch_array($result22);
									...
									$query = mysql_query("SELECT * FROM inventory_distribusi WHERE $pencarian_data tanggal_doc LIKE '%$rows22[tanggal_pencarian_list_dokumen_posting]%' AND jenis_doc LIKE '%$rows22[dokumen_pencarian_list_dokumen_posting]%' ORDER BY tanggal ASC LIMIT $mulai, $halaman")or die(mysql_error);
									$no =$mulai+1;
									//PAGING
