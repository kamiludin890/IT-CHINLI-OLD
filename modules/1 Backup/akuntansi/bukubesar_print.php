...
$query23="SELECT SUM(debit) FROM akuntansi_jurnal WHERE $akun_all AND tanggal BETWEEN '$rows22[saldo_awal_buku_besar1]' AND '$rows22[saldo_awal_buku_besar2]'";
$result23=mysql_query($query23);
$row23=mysql_fetch_array($result23);

$query24="SELECT SUM(kredit) FROM akuntansi_jurnal WHERE $akun_all AND tanggal BETWEEN '$rows22[saldo_awal_buku_besar1]' AND '$rows22[saldo_awal_buku_besar2]'";
...
$sheet1->writeString(2, 1, 'PT CHINLI PLASTIC TECHNOLOGY INDONESIA','wraptext_top');
