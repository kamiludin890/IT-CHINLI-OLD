...
//	echo "par:".	$id;
	...
	<li><label for='5'>".l(mysql_field_name($row, 5))."</label>". droprow('5','id,nama','pos_kontak',$r[5],"where kategori='customer'" )."</li>
	<li><label for='6'>".l(mysql_field_name($row, 6))."</label><input class='text' name='6' value='$r[6]' /></li>
	<li><label for='7'>".l(mysql_field_name($row, 7))."</label><textarea name='7' rows=8/>$r[7]</textarea></li>
	...
	<li><label for='11'>".l(mysql_field_name($row, 11))."</label>". tgl('11', $r[11])."</li>
	<li><label for='12'>".l(mysql_field_name($row, 12))."</label>". tgl('12', $r[12])."</li>
	<li><label for='13'>".l(mysql_field_name($row, 13))."</label>". tgl('13', $r[13])."</li>
	<li><label for='14'>".l(mysql_field_name($row, 14))."</label><textarea name='14' rows=8/>$r[14]</textarea></li>
	<li><label for='15'>".l(mysql_field_name($row, 15))."</label><textarea name='15' rows=8/>$r[15]</textarea></li>
...
function cetak(){extract($GLOBALS);
	...
	$document = file_get_contents("prints/tmp-claim.rtf");
	...
	$fr = fopen('prints/claim.rtf', 'w') ;
	fwrite($fr, $document);
	fclose($fr);
 	echo "<script type='text/javascript'>window.open('prints/claim.rtf')</script>";
