<?php global  $title, $mod, $tbl, $fld, $tbl2, $fld2, $akses ;
	...
	$tbl='salescl_po';
	$fld='id,kode,tanggal,customer,nopo';

	$tbl2='salescl_po_items';
	$fld2='id,induk,namabarang,ukuran,tebal,hardness,warna,size,qty,totalqty,unitprice,amount' ;
...
echo "<br> ini id: $id";	
	...
	<li><label for='8'>".l('totalqty')."</label><input class='text' name='items8' readonly></li>
	<li><label for='9'>".l('unitprice')."</label><input class='text' name='items9' ></li>
	<li><label for='10'>".l('amount')."</label><input class='text' name='items10' readonly></li>
	...
	$rest ="where induk='$id' ";
	$data='id,namabarang,ukuran,tebal,hardness,warna,size,qty,totalqty,unitprice,amount';
...
function tambah(){ extract($GLOBALS);
	...
	$id=$_POST['id'];
 	...
 	$t= explode(",", $_POST[items7]);
	$_POST[items8]=array_sum($t);
