...
function editform($id,$btn){ extract($GLOBALS); 
	...
	echo "<script type='text/javascript'>window.location.href='?menu=home&mod=admin/beli_items&res=h'</script>";
	}
 	}	
...
function lanjut(){ extract($GLOBALS);
	...
	$id=mysql_insert_id();
	$_SESSION['idinduk']=$id; 
	echo "<script type='text/javascript'>window.location.href='?menu=home&mod=admin/beli_items'</script>";
  	}	
