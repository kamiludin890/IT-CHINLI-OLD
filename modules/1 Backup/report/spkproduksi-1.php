...
//	echo "par:".	$id;
	...
	<li><label for='22'>".l(mysql_field_name($row, 22))."</label><input class='text' name='22' value='$r[22]' /></li>
	<li><label for='23'>".l(mysql_field_name($row, 23))."</label><input class='text' name='23' value='$r[23]' /></li>
	<li><label for='24'>".l(mysql_field_name($row, 24))."</label><input class='text' name='24' value='$r[24]' /></li>
	<li><label for='25'>".l(mysql_field_name($row, 25))."</label><input class='text' name='25' value='$r[25]' /></li>
	<li><label for='26'>".l(mysql_field_name($row, 26))."</label><input class='text' name='26' value='$r[26]' /></li>
	<li><label for='27'>".l(mysql_field_name($row, 27))."</label><input class='text' name='27' value='$r[27]' /></li>
	<li><label for='28'>".l(mysql_field_name($row, 28))."</label><input class='text' name='28' value='$r[28]' /></li>
	<li><label for='29'>".l(mysql_field_name($row, 29))."</label><input class='text' name='29' value='$r[29]' /></li>
