<?php global  $title, $mod, $tbl, $fld, $tbl2, $fld2, $akses ;
	...
	$fld2='id,induk,kodebarang,satuan,namabarang,ukuran,tebal,hardness,warna,size,qty,totalqty,unitprice,amount';
...
echo "<br> ini id: $id";
	...
	<li><label for='12'>".l('satuan')."</label><input class='text' name='items12' ></li>
	...
	$rest ="where induk='$id' ";
	$data='id,kodebarang,satuan,namabarang,ukuran,tebal,hardness,warna,size,qty,totalqty,unitprice,amount';
	...
	echo " <td > <input name='12[]' value='$row[12]' ></td> ";
	echo "</tr>";
	}
	echo "</tbody></table>";
	echo "</form>";
