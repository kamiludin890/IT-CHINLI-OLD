<?php global $mod;
	$mod='hrdpayroll/uangprofesional';
...
$column_header='tanggal,nik,nama,bagian,uang_profesional,tambah_bpjs';
$column='ket_revisi,uang_profesional,tambah_bpjs,pembuat,tgl_dibuat';//kontrak_awal1,kontrak_awal2,kontrak_akhir1,kontrak_akhir2,

$nama_database='hrd_data_karyawan';
//$nama_database_items='admin_purchasing_items';

$address='?mod=hrdpayroll/uangprofesional';
