...
$column_header='tanggal,bulan,tahun,jumlah_hari,jumlah_sabtu,jumlah_minggu,gaji_pokok,bonus_kehadiran,uang_makan,uang_transport,uang_shift,bpjs,jamsostek,dana_pensiun,thr';
$column='ket_revisi,tanggal,bulan,tahun,gaji_pokok,bonus_kehadiran,uang_makan,uang_transport,uang_shift,thr,pembuat,tgl_dibuat';//kontrak_awal1,kontrak_awal2,kontrak_akhir1,kontrak_akhir2,

$nama_database='hrd_payroll_tunjangan';
//$nama_database_items='admin_purchasing_items';

$address='?mod=hrdpayroll/tunjangan';
