...
$column_header='tanggal,departement,bagian,total_jam_kerja';
$column='ket_revisi,tanggal,departement,bagian,total_jam_kerja,pembuat,tgl_dibuat';//kontrak_awal1,kontrak_awal2,kontrak_akhir1,kontrak_akhir2,

$nama_database='hrd_payroll_bagian';
//$nama_database_items='admin_purchasing_items';

$address='?mod=hrdpayroll/bagian';
